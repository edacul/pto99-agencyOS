...
const byUserTable = 'grid-GZ3-EZZPsU';

const grouping = schemas.groupByUser;

const byUserTableMap = {
  'user_email' : 'c-ylvver62cA',
...
async function buildBody (tableMap, data) {
  ...
  array.forEach((datarow) => {
    skeleton.rows.push({
      "cells": [
        { "column": tableMap['user_email'], "value": datarow['_id']},
...
const wrapper = async function () { 
  await pushDailyGraph (doc,byUserTable) };

module.exports.pushByUser = wrapper;
